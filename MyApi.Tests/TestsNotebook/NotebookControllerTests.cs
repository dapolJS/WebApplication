...
namespace MyApi.Tests.NotebookTests
{
    public class NotebookControllerIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public async Task PostNotebookReturnsCreatedNotebook()
        {
            ...
            var response = await _client.PostAsync("/api/CreateNotebook", new StringContent(JsonConvert.SerializeObject(notebookDTO), Encoding.UTF8, "application/json"));
            ...
            // Assert
            Console.WriteLine(" ===> PostNotebookReturnsCreatedNotebook Response body : " + content);
        ...
        public async Task PostNotebookReturnsBadRequestWithoutTitle()
        {
            ...
            var response = await _client.PostAsync("/api/CreateNotebook", new StringContent(
                JsonConvert.SerializeObject(notebookDTO), Encoding.UTF8, "application/json"));
        ...
        public async Task PostNotebookReturnOkWithoutUniqueKey()
        {
            ...
            // Assert
            Console.WriteLine(" ===> PostNotebookReturnOkWithoutUniqueKey Response body : " + content);
            Notebook jsonContent = JsonConvert.DeserializeObject<Notebook>(content);
            Assert.NotEmpty(content);
        ...
        public async Task PostNotebookCreateNotebookWithExistingNote()
        {
            ...
            var response = await _client.PostAsync("/api/CreateNotebook", new StringContent(
                JsonConvert.SerializeObject(notebook), Encoding.UTF8, "application/json"));
            ...
            Console.WriteLine(" ===> PostNotebookCreateNotebookWithExistingNote Response body : " + content);
            Assert.NotEmpty(content);
        ...
        public async Task DeleteNotebookById()
        {
            ...
            var responseToBeDeletedNote = await _client.PostAsync("/api/CreateNotebook", new StringContent(JsonConvert.SerializeObject(notebookToBeDeleted), Encoding.UTF8, "application/json"));
